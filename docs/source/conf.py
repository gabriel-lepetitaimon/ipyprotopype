...
# -*- coding: utf-8 -*-
#
# ipyprotopypes documentation build configuration file
#
...
project = 'ipyprotopypes'
copyright = '2022, Gabriel Lepetit-Aimon'
...
_version_py = os.path.join(repo, 'ipyprotopypes', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyprotopypesdoc'
...
latex_documents = [
    (master_doc, 'ipyprotopypes.tex', 'ipyprotopypes Documentation',
     'Gabriel Lepetit-Aimon', 'manual'),
]
